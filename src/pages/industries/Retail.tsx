...
export const RetailPage: FC<RetailPageProps> = ({ language = 'zh' }) => {
  const trans = getTranslations(language)
  const t = trans.industries?.retail || {}
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            {t.cardGrid?.card1 && (
              <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <h3 class="text-xl font-bold text-gray-900 text-center mb-4">{t.cardGrid.card1.title}</h3>
                <p class="text-gray-600 text-center text-sm leading-relaxed">
                  {t.cardGrid.card1.description}
                </p>
              </div>
            )}
            ...
            {t.cardGrid?.card2 && (
              <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <h3 class="text-xl font-bold text-gray-900 text-center mb-4">{t.cardGrid.card2.title}</h3>
                <p class="text-gray-600 text-center text-sm leading-relaxed">
                  {t.cardGrid.card2.description}
                </p>
              </div>
            )}
            ...
            {t.cardGrid?.card3 && (
              <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <h3 class="text-xl font-bold text-gray-900 text-center mb-4">{t.cardGrid.card3.title}</h3>
                <p class="text-gray-600 text-center text-sm leading-relaxed">
                  {t.cardGrid.card3.description}
                </p>
              </div>
            )}
          </div>
                        ...
                        <ul class="space-y-3 md:space-y-4">
                          {item.features.map((feature: string, featureIndex: number) => (
                            <li key={featureIndex} class="flex items-start space-x-2 md:space-x-3">
                              ...
                              <span class="text-gray-700 font-medium text-sm md:text-base leading-relaxed">
                                {feature}
                              </span>
                            </li>
                          ))}
