...
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'cover_image_size';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'cover_image_type';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'video_file';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'video_size';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'video_type';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'attachment_file';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'attachment_size';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'attachment_type';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'attachment_name';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'reading_time';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'tags';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'download_url';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = 'ZENAVA_LOCAL' AND TABLE_NAME = 'resource_contents' AND COLUMN_NAME = 'video_url';
