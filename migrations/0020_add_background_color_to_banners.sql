...
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'resource_banners' AND COLUMN_NAME = 'background_color';
...
SET @col_exists = 0;
SELECT COUNT(*) INTO @col_exists FROM INFORMATION_SCHEMA.COLUMNS 
WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'category_banners' AND COLUMN_NAME = 'background_color';
